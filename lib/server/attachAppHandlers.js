...
module.exports = function(app, logger, login, userTracker, render, board, cfg, t) {
    ...
    app.get('/img/glyphicons-halflings.png', function(req, res){
        res.sendfile(__dirname + '/../../node_modules/bootstrap/docs/assets/img/glyphicons-halflings.png');
    });

    app.get('/img/glyphicons-halflings-white.png', function(req, res){
        res.sendfile(__dirname + '/../../node_modules/bootstrap/docs/assets/img/glyphicons-halflings-white.png');
    });
