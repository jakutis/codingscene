...
var generateClientSourceCode = function(debug) {
    return browserify(__dirname + '/../browserify.js', {
        debug : debug
    }).bundle() + fs.readFileSync(__dirname + '/../../node_modules/ace/build/src/ace.js');
};
...
module.exports = function(app, logger, cfg, t) {
    ...
    var srcdebug = generateClientSourceCode(true);
    var src = generateClientSourceCode(false);
